<script lang="ts">
  ...
  <View>
    <Card>
      <div class="grid grid-rows-[10vh_10vh_minmax(20vh,_40vh)_7vh_7vh]">
        <div
        ...
        >
          ...
          >
          ¡Felicitaciones por completar el Quiz!

          </p>
        </div>

            <p>
                ¡Lo lograste! Has superado nuestro desafiante quiz de práctica y eso merece un gran aplauso. 
                Queremos felicitarte por tu dedicación y esfuerzo al prepararte para tus futuros exámenes.
            </p>
