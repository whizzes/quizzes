    ...
    <div class="bottom-0">
      <div class="flex items-center">
        <button
          ...
          class="w-full p-4 {currentNumb === 1 &&
            'hidden'} text-base text-gray-600 bg-white border rounded-l-xl hover:bg-gray-100"
        >
          <svg
            width="9"
            fill="currentColor"
        ...
        <button
          type="button"
          class="w-full px-4 py-2 text-base text-indigo-500 bg-white border-t {currentNumb ===
            1 && 'rounded-l-xl border'}  border-b hover:bg-gray-100"
        >
          1
        </button>
        <button
        ...
        <button
          type="button"
          class="w-full px-4 {currentNumb === questionEntries.length - 1 &&
            'rounded-r-xl border'} py-2 text-base text-gray-600 bg-white border hover:bg-gray-100"
        >
        ...
        <button
          ...
          type="button"
          class="w-full {currentNumb === questionEntries.length - 1 &&
            'hidden'} p-4 text-base text-gray-600 bg-white border-t border-b border-r rounded-r-xl hover:bg-gray-100"
        >
          <svg
            width="9"
            fill="currentColor"
