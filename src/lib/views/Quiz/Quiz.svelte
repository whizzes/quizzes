...
<View>
  <Card>
    <div class="grid grid-rows-[8vh_10vh_minmax(40vh,_60vh)_1vh_7vh_7vh]">
      <div class="row-start-1 lg:text-5xl sm:text-3xl text-3xl font-extrabold text-center">
        <h2 class="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">
          {quiz && quiz.title}
        </h2>
      </div>

      <div class="flex text-xl font-extrabold text-left {currentQuestion.image === 'string' ? 'row-start-3' : 'row-start-2' } ">
